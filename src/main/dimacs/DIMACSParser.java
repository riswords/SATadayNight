...
public class DIMACSParser {
    ...
    /**
     * Parse a file that is in DIMACS format as input for a solver (using newVariable() and addClause() methods).
     *
     ...
     *
     * This discrepancy should also be accounted for when analyzing models generated by the solver.
     */
